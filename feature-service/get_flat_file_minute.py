...
for day in days:
  ...
  object_key = f"flatfiles/global_crypto/minute_aggs_v1/{year_str}/{month_str}/{day_str}.csv.gz"
...
# Save df_base
df_base.to_csv('./dataframes/df_x_minute_price_data.csv', index=False)
